if (!isDedicated) then {
	...
	//fn_getPos = 			compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fn_getPos.sqf";	
	fnc_dirTo = 						compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fnc_dirTo.sqf";	
	fnc_findSafePos = 			compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fnc_findSafePos.sqf";	
	fnc_vectRotate2D = 			compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fnc_vectRotate2D.sqf";	
	fnc_vectorAdd = 				compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fnc_vectorAdd.sqf";	
	BIS_fnc_invAdd = 				compile preprocessFileLineNumbers "dayz_code\system\functions\inventory\fn_invAdd.sqf";	
	BIS_fnc_invRemove = 		compile preprocessFileLineNumbers "dayz_code\system\functions\inventory\fn_invRemove.sqf";	
	BIS_fnc_infoText = 			compile preprocessFileLineNumbers "dayz_code\system\functions\GUI\fn_infoText.sqf";
	BIS_fnc_AAN = 					compile preprocessFileLineNumbers "dayz_code\system\functions\GUI\fn_AAN.sqf";
	bis_fnc_timetostring = 	compile preprocessFileLineNumbers "dayz_code\system\functions\strings\fn_timeToString.sqf";
	debug_monitor =					compile preprocessFileLineNumbers "dayz_code\actions\debug_monitor.sqf";
 	zombie_findOwner=					compile preprocessFileLineNumbers "dayz_code\compile\zombie_findOwner.sqf";
	BIS_fnc_nearestPosition = compile preprocessFileLineNumbers "dayz_code\system\functions\misc\fn_nearestPosition.sqf";
	BIS_fnc_findSafePos 		= compile preprocessFileLineNumbers "dayz_code\system\functions\misc\fn_findSafePos.sqf";
	BIS_fnc_areEqual 				= compile preprocessFileLineNumbers "dayz_code\system\functions\variables\fn_areEqual.sqf";
 	BIS_fnc_selectRandomWeighted =	compile preprocessFileLineNumbers "dayz_code\system\functions\MyFunctions\fn_selectRandomWeighted.sqf";


	BIS_Effects_Burn = 				compile preprocessFile "\ca\Data\ParticleEffects\SCRIPTS\destruction\burn.sqf"; 
	player_zombieCheck = 			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_zombieCheck.sqf";	//Run on a players computer, checks if the player is near a zombie
	player_zombieAttack = 		compile preprocessFileLineNumbers "dayz_code\compile\player_zombieAttack.sqf";	//Run on a players computer, causes a nearby zombie to attack them
	fnc_usec_damageActions =	compile preprocessFileLineNumbers "dayz_code\compile\fn_damageActions.sqf"; //\z\addons\		//Checks which actions for nearby casualty   //FRIENDLY CHECK TESTING \z\addons\
  ...
  control_zombieAgent = 	compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\control_zombieAgent.sqf";
	player_updateGui =			compile preprocessFileLineNumbers "dayz_code\compile\player_updateGui.sqf"; //\z\addons\
	...
	fn_gearMenuChecks =			compile preprocessFileLineNumbers "dayz_code\compile\fn_gearMenuChecks.sqf";  //\z\addons
	...
	zombie_loiter = 					compile preprocessFileLineNumbers "dayz_code\compile\zombie_loiter.sqf";			//Server compile, used for loiter behaviour
	zombie_generate = 				compile preprocessFileLineNumbers "dayz_code\compile\zombie_generate.sqf";			//Server compile, used for loiter behaviour
	...
	//player_antiWall =		compile preprocessFileLineNumbers "dayz_code\compile\player_antiWall.sqf";
	...
	player_spawn_1 =			compile preprocessFileLineNumbers "dayz_code\system\player_spawn_1.sqf";
	...
	//	call compile preprocessFileLineNumbers "dayz_code\compile\player_traderMenuConfig.sqf";
		...
		call compile preprocessFileLineNumbers "dayz_code\compile\player_traderMenuHive.sqf";
	};
...
*/
	...
	object_setFixServer =			compile preprocessFileLineNumbers "dayz_code\compile\object_setFixServer.sqf";	//process the hit as a NORMAL damage (useful for persistent vehicles)
	...
	fnc_veh_ResetEH = 				compile preprocessFileLineNumbers "dayz_code\init\veh_ResetEH.sqf";			//Initialize vehicle
	// Vehicle damage fix
