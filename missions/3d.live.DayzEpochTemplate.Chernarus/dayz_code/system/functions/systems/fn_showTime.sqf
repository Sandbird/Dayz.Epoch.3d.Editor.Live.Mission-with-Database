...
*/
private ["_dateStartArray","_dateEndArray","_subCoef","_monthList","_yearStart","_yearEnd","_dateStart","_dateEnd","_diff","_diffDays","_speedCoef","_date","_dateBorder","_startYear","_startMonth","_startMonthString","_startDay","_startHour","_startMinute","_ctrlText","_coef","_start","_currentDate","_currentYear","_dateArray","_currentMonth","_currentMonthString","_currentDay","_currentHour","_currentMinute","_debug","_text","_delay"];
disableserialization;

//0 cuttext ["","black in"];0 cutfadeout 10000;
//sleep 0.001;

1 cutRSC ["RscTime","plain"];
///////////////////////////////////////////////////////////////////////////////
