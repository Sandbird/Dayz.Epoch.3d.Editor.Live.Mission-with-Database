...
private ["_handle", "_musicTime", "_musicTrack"];
_musicTime = -200;
_musicTrack = "Track27_Killing_Machines";
if ((configName (configFile >> "CfgMusic" >> _musicTrack)) == "") then {_musicTrack = "EP1_Track05";};
...
while {alive player} do 
{
	...
	{
		_handle = _musicTrack spawn _startMusicScript;
		_musicTime = time;
	};
