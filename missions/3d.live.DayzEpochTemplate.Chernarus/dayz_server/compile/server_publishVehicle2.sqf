...
_key = format["insert into object_data (ObjectUID, Instance, Classname, CharacterID, Worldspace, Inventory, Hitpoints, Fuel, Damage) values ('%1','%2','%3','%4','%5','%6','%7','%8','%9')",_uid,dayZ_instance,_class,_characterID,_worldspace,[],[],1,0];
