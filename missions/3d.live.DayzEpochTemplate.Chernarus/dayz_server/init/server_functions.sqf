BIS_Effects_Burn =				{};
server_publishVeh = 			compile preprocessFileLineNumbers "dayz_server\compile\server_publishVehicle.sqf";
server_publishVeh2 = 			compile preprocessFileLineNumbers "dayz_server\compile\server_publishVehicle2.sqf";
...
server_deleteObj =				compile preprocessFileLineNumbers "dayz_server\compile\server_deleteObj.sqf";
server_updateObject =			compile preprocessFileLineNumbers "dayz_server\compile\server_updateObject.sqf";
server_publishObj = 			compile preprocessFileLineNumbers "dayz_server\compile\server_publishObject.sqf";
server_swapObject =				compile preprocessFileLineNumbers "dayz_server\compile\server_swapObject.sqf"; 
...
server_hiveRead = {
	...
	_resultArray = _resultArray select 0;
	_resultArray
};
...
server_hiveReadWriteLarge = {
	...
	_data = format["Arma2NETMySQLCommand ['%2',""%1""]",_key, DB_NAME];
	SQL_RESULT = "Arma2Net.Unmanaged" callExtension _data;
	_resultArray = call compile SQL_RESULT;
	_resultArray
};
...
spawn_vehicles = {
	...
	if (!isServer) exitWith { }; //Be sure the run this
...
server_spawnCleanLoot = {
	...
	{
		_keep = (_x getVariable ["permaLoot",false]) || (_x getVariable ["DZAI",0] == 1); // Sandbird
		if (!_keep) then {
