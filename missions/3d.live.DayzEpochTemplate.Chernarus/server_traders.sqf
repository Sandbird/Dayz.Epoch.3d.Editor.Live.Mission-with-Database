...
// Hooker clerk  177
menu_Hooker2 = [
	[["!!! Crazy Dealz !!!",2010],["Special Vehicles (Backyard)",2011],["Special Weapons",2012],["Special Ammo",2013],["Traps and Explosives",2014],["BUILDING COMPONENTS",2015],["BUILDING TOOLS",2016],[">EXCHANGE<",2017]],
	[],
	"neutral"
];

// Hooker at corner   178
menu_Hooker4 = [
	[["INFO - FREE SAFES",2001],["HOWTO - FREE SAFES",2002],["SECURITY STUFF",2003]],
	[],
	"neutral"
];

//DrugDealer
menu_TK_GUE_Soldier_AAT_EP1 = [
    [["Drugs",2018]],
	[],
    "neutral"
];